<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        ...
        <a href="#" class="logo logo-dark">
            <span class="logo-sm">
                <img src="https://mainin.com.pe/wp-content/themes/industro/images/favicon-mainin.png" alt=""
                    height="22">
            </span>
            <span class="logo-lg">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarConfiguracion" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="ri-file-list-3-line"></i> <span data-key="t-forms">Configuración</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarConfiguracion">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{ route('configuracion.usuarios') }}" class="nav-link">
                                    Usuarios
                                </a>
                            </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarAlmacen" data-bs-toggle="collapse" role="button"
                        aria-expanded="false" aria-controls="sidebarAlmacen">
                        <i class="ri-user-2-line"></i> <span data-key="t-forms">Almacen</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarAlmacen">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{ route('almacen.almacenes') }}" class="nav-link">
                                    Almacenes
                                </a>
